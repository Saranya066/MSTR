...
public static void setCellData(String Result,  int RowNum, String sColName,String sSheetName) throws Exception    {
	try
	{
		...
		// Constant variables Test Data path and Test Data file name
		 FileOutputStream fileOut = new FileOutputStream(System.getProperty("user.dir")+"/TestData/"+Driver.properties.getProperty("DataFile"));
...
//Base framework, kept as reference for later use - Devi
/*
 * public class ExcelDataProvider {
 * 
 * XSSFWorkbook wb;
 * 
 * //Constructor to initialize variable and object public ExcelDataProvider()
 * 
 ...
 * 
 * wb=new XSSFWorkbook(fis); } catch (Exception e) {
 * System.out.println("Unable to read Excel file" +e.getMessage()); }
 * 
 * }
 * 
 * //Method Overloading: Same method name with different type value public
 * String getStringData(int sheetIndex,int row,int column) { return
 ...
 * 
 * public double getNumericData(String sheetname,int row,int column) { return
