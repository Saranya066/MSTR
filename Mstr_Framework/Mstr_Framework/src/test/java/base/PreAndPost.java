...
public class PreAndPost extends WebDriverEvents {
	...
	public static void setUp() throws Exception {
		...
		// read excel file
		String sExcelFilePath = System.getProperty("user.dir") + "\\TestData\\" + properties.getProperty("DataFile");
		DataInputProvider.setExcelFile(sExcelFilePath, properties.getProperty("DriverSheetName"));

		URL = properties.getProperty("WDCDEV2URL");
		// String URL=ConfigDataProvider.getDEV01URL();
		// Deleted column Environment in MasterData excel for the below loc
		// URL=DataInputProvider.getCellData_ColName(1,
		// "Environment",properties.getProperty("DriverSheetName"));
		...
		htmlReporter.config().setReportName("Quality Measures Reporter Automation Test Results");
	...
	public void beforeMethod() throws Exception {
	    ...
	    getDriver().manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);
