...
public class PhysicianComparativeNonAggregated extends WebDriverServiceImpl {

	public PhysicianComparativeNonAggregated clickPhysicianComparativeNonAggregated() throws InterruptedException {

		iframeHandling();
		click(getDriver()
				.findElement(By.xpath("//div[contains(text(),'Attending Physician Comparative - Non-Aggregated')]")),
				"PhysicianComparativeNonAggregated");
...
// Quarter button selection
	public PhysicianComparativeNonAggregated clickQtrcaretSymbol() throws InterruptedException {
	...
	// Hospital selection
	public PhysicianComparativeNonAggregated clickHospital() throws InterruptedException {
		Thread.sleep(5000);
	...
	// Physician
	public PhysicianComparativeNonAggregated clickPhysicianQtr() throws InterruptedException {
	...
	public PhysicianComparativeNonAggregated clickPatientClass() throws InterruptedException {
	...
	// Run Document
	public PhysicianComparativeNonAggregated clickRunDocument() throws InterruptedException {
		iframeHandling();
	...
	public PhysicianComparativeNonAggregated clickAllComparative() throws InterruptedException {
		iframeHandling();
	...
	public PhysicianComparativeNonAggregated clickAllTrendedGraph() throws InterruptedException {
		iframeHandling();
	...
	public PhysicianComparativeNonAggregated clickAllTrendedData() throws InterruptedException {
		iframeHandling();
	...
	//Assert verification
    public PhysicianComparativeNonAggregated assertPhysicianComparativeNonAggregated() throws InterruptedException {
        Thread.sleep(3000);
        iframeHandling();
    ...
    public PhysicianComparativeNonAggregated backToReportsHome() throws InterruptedException {
        Thread.sleep(3000);
        iframeHandling();
