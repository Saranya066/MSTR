...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	public static String getScreenshot() throws IOException {
		...
		screenshotPath = System.getProperty("user.dir") + "/Screenshots/" + java.time.LocalDate.now() + "/"
	...
	public WebElement locateElement(String locator, String locValue) {
		try {
			...
			setReport().log(Status.FAIL,
					"Unknown exception occured while finding  " + locator + " with the value " + locValue);
			Driver.failCount++;
			throw e;
		}
		return null;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void type(WebElement ele, String data, String fieldName) {
		try {
			...
			if (fieldName.equalsIgnoreCase("password")) {
				...
				if (sExpectedValue.equalsIgnoreCase(data)) {
					...
					setReport().log(Status.PASS,
							"The data: " + encodedData + " successfully entered in  " + fieldName + " field",
							screenshotCapture());
				} else {
					setReport().log(Status.FAIL, "The data: " + encodedData + " is NOT entered in : " + fieldName,
							screenshotCapture());
					Driver.failCount++;
				}
			} else {
				if (sExpectedValue.equalsIgnoreCase(data)) {
					setReport().log(Status.PASS,
							"The data: " + data + " successfully entered in  " + fieldName + " field",
							screenshotCapture());
				} else {
					setReport().log(Status.FAIL, "The data: " + data + " is NOT entered in : " + fieldName,
							screenshotCapture());
					Driver.failCount++;
				}
			}
			...
			setReport().log(Status.FAIL, "The data: " + data + " could not be entered in  : " + fieldName,
					screenshotCapture());
			Driver.failCount++;
			throw e;
		} catch (WebDriverException e) {
			e.printStackTrace();
			setReport().log(Status.FAIL, "Unknown exception occured while entering  " + data + " in " + fieldName,
					screenshotCapture());
			Driver.failCount++;
			throw e;
		}
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	...
	public void typeAndChoose(WebElement ele, String data, String field) {
		try {
			...
			setReport().log(Status.PASS, "The data: " + data + " entered successfully in  :" + field,
					screenshotCapture());
		} catch (InvalidElementStateException e) {
			setReport().log(Status.FAIL, "The data: " + data + " could not be entered in the field :" + field,
					screenshotCapture());
			Driver.failCount++;
			throw e;
		} catch (WebDriverException e) {
			setReport().log(Status.FAIL,
					"Unknown exception occured while entering  " + data + " in the field :" + field,
					screenshotCapture());
			Driver.failCount++;
			throw e;
		}
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	public void selectDropdown(WebElement ele, String data, String field) {
		try {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void clickAndChoose(WebElement ele, String data, String field) {
		try {
			...
			setReport().log(Status.PASS, "The data: " + data + "entered successfully in the field :" + field,
					screenshotCapture());
		} catch (InvalidElementStateException e) {
			setReport().log(Status.FAIL, "The data: " + data + "could not be entered in the field :" + field,
					screenshotCapture());
...
//			wait.until(ExpectedConditions.elementToBeClickable(ele));			
			...
			e.printStackTrace();
			setReport().log(Status.FAIL, "Unknown exception occured while clicking in the field : " + field,
					screenshotCapture());
			Driver.failCount++;
		}
	}
...
//			wait.until(ExpectedConditions.elementToBeClickable(ele));			
			...
			// WebElement ele =
			// getDriver().findElement(By.xpath("//span[contains(text(),'2021 Q3')]"));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	public void clickWithNoSnap(WebElement ele) {
		...
		try {
			...
			setReport().log(Status.FAIL, "Unknown exception occured while clicking in the field : " + text,
					screenshotCapture());
			e.printStackTrace();
			Driver.failCount++;
			throw e;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void selectDropDownUsingVisibleText(WebElement ele, String value, String field) {
		try {
			...
			setReport().log(Status.PASS, field + " found", screenshotCapture());
		} catch (WebDriverException e) {
	...
	public boolean verifyExactTitle(String title) {
		...
		try {
			if (getTitle().equals(title)) {
				setReport().log(Status.PASS, "The title of the page matches with the value : " + title,
						screenshotCapture());
				bReturn = true;
			} else {
				setReport().log(Status.FAIL,
	...
	public void verifyExactText(WebElement ele, String expectedText, String field) {
		...
		try {
			if (bReturn.equalsIgnoreCase(expectedText)) {
				setReport().log(Status.PASS, "The text :" + bReturn + " matches with the value in " + field + " field",
						screenshotCapture());
			} else {
				setReport().log(Status.FAIL,
						"The text :" + bReturn + " did not match with the value in " + field + " field",
						screenshotCapture());
				Driver.failCount++;
			}
		} catch (WebDriverException e) {
			setReport().log(Status.FAIL, "Unknown exception occured while verifying the Text in " + field + " field",
					screenshotCapture());
			Driver.failCount++;
			throw e;
		}
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void verifyExactAttribute(WebElement ele, String attribute, String value, String field) {
		try {
			...
			setReport().log(Status.FAIL, "Unknown exception occured while verifying the attribute",
					screenshotCapture());
			Driver.failCount++;
			throw e;
		}
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void switchToWindow(int index) {
		try {
			...
			setReport().log(Status.FAIL, "The driver could not move to the given window by index " + index,
					screenshotCapture());
		} catch (WebDriverException e) {
			setReport().log(Status.FAIL, "WebDriverException" + e.getMessage(), screenshotCapture());
			Driver.failCount++;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void switchToDefaultContent() {
		try {
			...
			// setReport().log(Status.PASS, "switch out to Default Content
			// ",screenshotCapture());
		} catch (NoSuchFrameException e) {
			setReport().log(Status.FAIL, "WebDriverException" + e.getMessage(), screenshotCapture());
			Driver.failCount++;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void selectDropDownUsingValue(WebElement ele, String value) {
		try {
			...
			setReport().log(Status.PASS, "The dropdown " + ele + " is selected with text : " + value,
					screenshotCapture());
		} catch (WebDriverException e) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void clearAndType(WebElement ele, String data, String field) {
		try {
			...
			String sExpectedValue = ele.getAttribute("value");
			if (sExpectedValue.equalsIgnoreCase(data)) {
				setReport().log(Status.PASS, "The data: " + data + " successfully entered in  " + field + " field",
						screenshotCapture());
			} else {
				setReport().log(Status.FAIL, "The data: " + data + " is NOT entered in : " + field,
						screenshotCapture());
				Driver.failCount++;
			}
		} catch (InvalidElementStateException e) {
			setReport().log(Status.FAIL, "The data: " + data + " could not be entered in  : " + field,
					screenshotCapture());
			Driver.failCount++;
			throw e;
		} catch (WebDriverException e) {
			e.printStackTrace();
			setReport().log(Status.FAIL, "Unknown exception occured while entering  " + data + " in " + field,
					screenshotCapture());
			Driver.failCount++;
			throw e;
		}
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public static void windowHandling() {
		...
		getDriver().switchTo().window(parent_window).close();
...
//Moving to Iframe
	...
	public static void iframeHandling() {
		getDriver().switchTo().frame(getDriver().findElement(By.xpath("//iframe[@class='mstr']")));
	}
...
public void assertVerification(WebElement ele, String field) {
	try {
		// WebDriverWait wait = new WebDriverWait(getDriver(), 15);
//		wait.until(ExpectedConditions.elementToBeClickable(ele));	
		Assert.assertEquals(ele.getText(), field);
		//ele.click();
		setReport().log(Status.PASS, "Assert Verification: Clicked on " + field, screenshotCapture());
	} catch (InvalidElementStateException e) {
		e.printStackTrace();
		setReport().log(Status.FAIL, field + " could not be clicked", screenshotCapture());
		Driver.failCount++;
